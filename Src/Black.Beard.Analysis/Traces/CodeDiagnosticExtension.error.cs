...
namespace Bb.Analysis.Traces
{
    ...
    public static partial class CodeDiagnosticExtension
    {
        ...
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string text, string message)
        {
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, string text, string message)
        {
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, string path, string text, string message)
        {
            return self.Add(SeverityEnum.Error,
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, int index, string text, string message)
        {
            return self.Add(SeverityEnum.Error,
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, int line, int column, string text, string message)
        {
            return self.Add(SeverityEnum.Error,
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, int line, int column, int index, string text, string message)
        {
            return self.Add(SeverityEnum.Error,
        ...
        /// <param name="message">The message.</param>
        /// <returns><see cref="T:DiagnosticReport"></returns>
        public static ScriptDiagnostic Error(this ScriptDiagnostics self, string filename, 
